package maktab.imthonproject.Helper.Validation;

public class ValidByName {
    ...
    public static final String ID_NULL = "Id bo'sh bo'lishi mumkin emas";
    public static final String NAME_FORMAT = "Hafta kunlari fromati mos emas Rus yoki Uzbek yoki Engliz tilida kirigin";
}
